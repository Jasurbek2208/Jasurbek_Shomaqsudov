        ...
        <form onSubmit={handleSubmit}>
          <div className="input">
            ...
            <Input
              type="text"
              forID="fullname"
              isError={error.name[0]}
              placeholder="Write your fullname"
              onChange={() => changeInputs("name")}
            />
          ...
          <div className="input">
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                if (!e.target.validity.valid) {
                  e.target.setCustomValidity(
                    "The number was entered incorrectly ! Example: +998971050505"
                  );
                }
              }}
            />
            ...
            {error.phone[0] && (
              <span className="error-message">{error.phone[1]}</span>
            )}
          </div>
          ...
          <div className="input">
            ...
            <Input
              type="textarea"
              forID="message"
              isError={error.message[0]}
              placeholder="Write your short message"
              onChangeArea={() => changeInputs("message")}
            />
            ...
            {error.message[0] && (
              <span
                className={
                  "error-message" +
                  (error.message[1].trim().length >= 24 ? " long" : "")
                }
              >
                {error.message[1]}
              </span>
